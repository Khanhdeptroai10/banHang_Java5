                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                        ...
                        <span class="menu-link">
											...
											<span class="menu-arrow d-lg-snone"></span>
										</span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                            ...
                            <div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
                                        <img src="/public/assets/media/stock/900x600/45.jpg" class="rounded mw-100" alt="" />
                                    </div>
                                    <!--end:Col-->
                                </div>
                                <!--end:Row-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
                        ...
                        <span class="position-absolute top-0 start-0 translate-middle badge badge-sm badge-circle badge-danger" ${cart.size() == 0 ? "hidden" : ""}>${cart.size()}</span>
                    </div>
                    <!--begin::Menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-450px w-lg-475px" data-kt-menu="true" id="kt_menu_notifications">
                        <!--begin::Heading-->
