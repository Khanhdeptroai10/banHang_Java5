            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
                        <i class="ki-outline ki-shop fs-1">
                            <span class="path1"></span>
                            <span class="path2"></span>
                            <span class="path3"></span>
                            <span class="path4"></span>
                        </i>
                        <span class="position-absolute top-0 start-100 translate-middle badge badge-sm badge-circle badge-danger" ${cart == null ||  cart.size() <= 0 ? "hidden" : ""}>${cart.size()}</span>
                    </div>
                    <!--begin::Menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('/public/assets/media/misc/menu-header-bg.jpg')">
                            <!--begin::Title-->
                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Cart
                                <span class="fs-8 opacity-75 ps-3">Cart Items</span></h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Tab content-->
                        <div class="container">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-70px0px">Product</th>
                                    <th class="min-w-50px text-center pe-5">Qty</th>
                                    <th class="min-w-50px text-end pe-5">Total</th>
                                </tr>
                                </thead>
                            ...
                            <!--end::Table-->
                            <!--begin::Actions-->
                            <a href="/cart" ${cart == null || cart.size() <= 0 ? "hidden" : ""} class="btn btn-primary w-100">Go to checkout</a>
                            <!--end::Actions-->
                        </div>
                        <!--end::Tab content-->
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">${nhanVien.ten}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">${nhanVien.vaiTro ? "admin" : "employee"}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
