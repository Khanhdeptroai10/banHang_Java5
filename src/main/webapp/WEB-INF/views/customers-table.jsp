                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <form:form id="kt_account_profile_details_form"
                                  ...
                                  action="/customer/create" method="post" modelAttribute="khachHang">
                                <!--begin::Card body-->
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the customer code.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the customer's name.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the customer's phone number.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    ...
                                    <!--begin::Add customer-->
                                    <a href="/customers/table" class="btn btn-primary">Add
                                        Customer</a>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Card toolbar-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                    ...
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-end min-w-100px">Customer code</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="apps/ecommerce/catalog/edit-customer.html"
                                                           class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                           data-kt-ecommerce-customer-filter="customer_name">${customer.ten}</a>
                                                        <!--end::Title-->
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-end pe-0" data-order="Scheduled">
                                                <!--begin::Badges-->
                                                <div class="badge ${customer.trangThai ? "badge-light-primary" : "badge-light-danger"}">${customer.trangThai ? "Active" : "Locked"}</div>
                                                <!--end::Badges-->
                                            </td>
                                            <td class="text-end">
                                                <a href="#"
                                ...
                                <ul class="pagination">
                                    <li class="page-item previous ${currentPage == 0 ? 'disabled' : ''}">
                                        <a href="/customers/table?page=${currentPage - 1}&pageSize=${pageSize}" class="page-link"><i class="previous"></i></a>
                                    </li>
                                    <c:forEach begin="0" end="${totalPages - 1}" var="pageNumber">
                                        <li class="page-item ${currentPage == pageNumber ? 'active' : ''}">
                                            <a href="/customers/table?page=${pageNumber}&pageSize=${pageSize}" class="page-link">${pageNumber + 1}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item next">
                                        <a href="/customers/table?page=${currentPage + 1}&pageSize=${pageSize}" class="page-link"><i class="next"></i></a>
                                    </li>
                                </ul>
                                <!--end::Pagination-->
                            </div>
