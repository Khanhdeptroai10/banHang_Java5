                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <!--begin::Form search-->
                                <form action="/products/colors/search" method="get">
                                    <!--begin::Card title-->
                                    <div class="card-title">
                                        <!--begin::Search-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                    ...
                                    <tr ${colors.size() > 0 ? "hidden" : ""}>
                                        <td colspan="5" class="text-center">No color</td>
                                    </tr>
                                    </tbody>
                                </table>
                                <!--end::Table-->
                                <c:if test="${totalPages > 0}">
                                    ...
                                    <ul class="pagination">
                                        <li class="page-item previous ${currentPage == 0 ? 'disabled' : ''}">
                                            <a href="/products/colors?page=${currentPage - 1}&pageSize=${pageSize}"
                                               class="page-link"><i class="previous"></i></a>
                                        </li>
                                        <c:forEach begin="0" end="${totalPages - 1}" var="pageNumber">
                                            <li class="page-item ${currentPage == pageNumber ? 'active' : ''}">
                                                <a href="/products/colors?page=${pageNumber}&pageSize=${pageSize}"
