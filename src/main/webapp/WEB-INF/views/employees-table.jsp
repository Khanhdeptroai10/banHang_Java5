                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <form:form id="kt_account_profile_details_form"
                                       ...
                                       action="/employee/create" method="post" modelAttribute="nhanVien">
                                <!--begin::Card body-->
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the employee code.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                        <form:errors path="maNV" class="text-danger fs-7"/>
                                        <!--end::Error-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the employee's name.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the employee's username.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                        <form:errors path="tenDangNhap" class="text-danger fs-7"/>
                                        <!--end::Error-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Enter the employee's password.</div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                        <form:errors path="matKhau" class="text-danger fs-7"/>
                                        <!--end::Error-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    ...
                                    <div class="form-check form-check-custom form-check-solid mb-2">
                                        <form:radiobuttons path="vaiTro" items="${role}" delimiter=" "
                                                           class="form-check-input"/>
                                    </div>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Please choose role</div>
                                    <!--end::Description-->
                                    <!--begin::Error-->
                                    <form:errors path="vaiTro" class="text-danger fs-7"/>
                                    <!--end::Error-->
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Allow employees to purchase employees that are out
                                            of stock.
                                        </div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <div class="w-100 mw-150px">
                                        ...
                                        <select class="form-select form-select-solid" data-control="select2"
                                                ...
                                                data-kt-ecommerce-employee-filter="status">
                                            <option></option>
                                    ...
                                    <!--begin::Add employee-->
                                    <a href="/employees/table" class="btn btn-primary">Add
                                        Employee</a>
                                    <!--end::Add employee-->
                                </div>
                                <!--end::Card toolbar-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                    ...
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-end min-w-100px">Employee code</th>
                                    ...
                                    <c:forEach items="${employees}" var="employee" varStatus="i">
                                        <tr ${employees.size() == 0 ? "hidden" : ""}>
                                            ...
                                            <td class="text-end pe-0" data-order="Scheduled">
                                                <!--begin::Badges-->
                                                <div class="badge ${employee.vaiTro ? "badge-light-success" : "badge-light-primary"}">${employee.vaiTro ? "Admin" : "Employee"}</div>
                                                <!--end::Badges-->
                                            </td>
                                            <td class="text-end pe-0" data-order="Scheduled">
                                                <!--begin::Badges-->
                                                <div class="badge ${employee.trangThai ? "badge-light-primary" : "badge-light-danger"}">${employee.trangThai ? "Active" : "Locked"}</div>
                                                <!--end::Badges-->
                                            </td>
                                            <td class="text-end">
                                                <a href="#"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a onclick="return confirm('Do you want to delete this item?')"
                                                           href="/employees/delete?id=${employee.id}"
                                                           class="menu-link px-3"
                                                           data-kt-ecommerce-employee-filter="delete_row">Delete</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
